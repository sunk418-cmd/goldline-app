...
export const INITIAL_RISK_DATA: RiskAssessment[] = [
  {
    ...
    riskFactors: [
      { id: '1-f1', jobType: '궤도', factor: '열차 진입에 의한 충돌 사고 위험' },
      { id: '1-f2', jobType: '궤도', factor: '분기부 가동부 손가락 협착 위험' },
    ],
  ...
  },
  {
    ...
    riskFactors: [
      { id: '2-f1', jobType: '궤도', factor: '무거운 레일 취급 중 근골격계 질환 및 끼임' },
      { id: '2-f2', jobType: '전기', factor: '전차선 근접 작업 시 감전 위험' },
    ],
    updatedAt: new Date().toISOString(),
  }
];
